...
The script allows to generate a tabulated format report of repeats annotated from a gff file containing repeats (type must be math or protein_match).

=head1 SYNOPSIS

    gff3_sq_repeats_analyzer.pl -i <input file> [-g <integer or fasta> -o <output file>]
    gff3_sq_repeats_analyzer.pl --help
