...
gff3_sq_stat_basic.pl -
The script allows to generate a tabulated format report of feature types annotated from a gff file.

=head1 SYNOPSIS

    gff3_sq_stat_basic.pl -i <input file> [-g <integer or fasta> -o <output file>]
    gff3_sq_stat_basic.pl --help
