...
my $script = $script_prefix . catfile($bin_dir, "agat_convert_bed2gff.pl");
...

{
    ...
    check_quiet_run("$script --bed " . catfile($input_folder, 'test.bed') . " -o $outtmp");
    check_diff($outtmp, $result, 'output agat_convert_bed2gff.pl');
}
