...
my $script = $script_prefix . catfile($bin_dir, "agat_convert_embl2gff.pl");
...
{   
    ...
    check_quiet_run("$script --embl " . catfile($input_folder, 'agat_convert_embl2gff_1.embl') . " --emblmygff3 -o $outtmp");
    check_diff($outtmp, $result, 'output agat_convert_embl2gff.pl');
}
