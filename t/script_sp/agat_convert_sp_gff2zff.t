...
my $script = $script_prefix . catfile($bin_dir, "agat_convert_sp_gff2zff.pl");

{ ok(system("$script -h 1>\/dev\/null") == 0, "help $script"); }

{
    my $dir = setup_tempdir();
    my $outtmp = catfile($dir,'tmp.ann');
    ...
    check_diff($outtmp, $result, 'output agat_convert_sp_gff2zff.pl');
}
