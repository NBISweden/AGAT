...
my $script = $script_prefix . catfile($bin_dir, "agat_sp_ensembl_output_style.pl");
...

{
    ...
    check_quiet_run(
        "$script --gff " . catfile($input_folder,'0.gff') .
        " -o $outtmp"
    );
    check_diff($outtmp, $result, 'output agat_sp_ensembl_output_style.pl');
}
