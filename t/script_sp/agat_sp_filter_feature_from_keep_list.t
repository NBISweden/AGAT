...
my $script = $script_prefix . catfile($bin_dir, "agat_sp_filter_feature_from_keep_list.pl");
...
my $result = "$output_folder/agat_sp_filter_feature_from_keep_list_1.gff";
{
    ...
    check_quiet_run(
        ...
        " --keep_list " . catfile($input_folder,'keep_list.txt') .
        " -o $outtmp"
    );
    check_diff($outtmp, $result, 'output agat_sp_filter_feature_from_keep_list.pl');
}
