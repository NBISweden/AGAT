...
my $script = $script_prefix . catfile($bin_dir, "agat_sp_filter_feature_from_kill_list.pl");
...

{
    ...
    check_quiet_run(
        ...
        " --kl " . catfile($input_folder,'kill_list.txt') .
        " -o $outtmp"
    );
    check_diff($outtmp, $result, 'output filter_feature_from_kill_list');
}
