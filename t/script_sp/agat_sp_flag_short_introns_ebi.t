...
my $script = $script_prefix . catfile($bin_dir, "agat_sp_flag_short_introns_ebi.pl");
...

{
    ...
    check_quiet_run(
        "$script --gff " . catfile($input_folder,'agat_sp_flag_short_introns_ebi.gff') . " -o $outtmp"
    );
    check_diff($outtmp, $result, 'output agat_sp_flag_short_introns_ebi.pl');
}
