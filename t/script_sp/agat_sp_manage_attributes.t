...
my $script = $script_prefix . catfile($bin_dir, "agat_sp_manage_attributes.pl");
...

{
    ...
    check_quiet_run(
        "$script --gff " . catfile($input_folder,'1.gff') . " --att protein_id -o $outtmp"
    );
    check_diff($outtmp, $result, 'output agat_sp_manage_attributes.pl');
}
