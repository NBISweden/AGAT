...
my $script = $script_prefix . catfile($bin_dir, "agat_sp_move_attributes_within_records.pl");
...

{
    ...
    check_quiet_run(
        "$script --gff " . catfile($input_folder,'agat_sp_move_attributes_within_records.gff') .
        " --fp exon,CDS --fc mRNA -o $outtmp"
    );
    check_diff($outtmp, $result, 'output agat_sp_move_attributes_within_records.pl');
}
