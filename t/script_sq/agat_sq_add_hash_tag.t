...
my $script = $script_prefix . catfile($bin_dir, "agat_sq_add_hash_tag.pl");
...

{
    ...
    check_quiet_run(
        "$script --gff " . catfile($input_folder,'1.gff') . " -i 2 -o $outtmp"
    );
    check_diff($outtmp, $result, 'output agat_sq_add_hash_tag.pl');
}
